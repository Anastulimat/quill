    ...
    return (
        <>
            <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
                ...
                overflow-hidden rounded-full border border-gray-200 bg-white px-7 py-2 shadow-md backdrop-blur transition-all
                ...
                <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
                    Quill allows you to have conversions with any PDF files. <br/>
                ...
                <div className="realtive isolate">
                    ...
                    >
                        <div style={{
                            ...
                            className="relative left-[clacl(50%-11rem] aspect-[1155/678] w-[36.125rem]
                    ...
                    <div>
                        <div className="mx-atuo max-w-6xl px-6 lg:px-8">
